...
class GifMerge {
    ...
    private $mod			= 'C_FILE';
    private $first			= true;
    private $use_loop			= false;
    private $transparent		= false;
    private $use_global_in		= false;
    private $x				= 0;
    private $y				= 0;
    private $ch				= 0;
    private $fin			= 0;
    ...
    private $trans3 			= 255;
    private $disposal			= 2;
    private $out_color_table_size	= 0;
    private $local_color_table_flag	= 0;
    private $global_color_table_size	= 0;
    private $out_color_table_sizecode	= 0;
    private $global_color_table_sizecode= 0;
    private $gif			= array(0x47, 0x49, 0x46);
    private $buffer			= array();
    private $local_in			= array();
    private $global_in			= array();
    private $global_out			= array();
    private $logical_screen_descriptor	= array();
