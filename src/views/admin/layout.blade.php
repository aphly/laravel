...
<link rel="stylesheet" href="{{ URL::asset('static/base/admin/css/admin.css') }}">
                    ...
                    <div class="dropdown">
                        <a style="display: block" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <div class="user_dropdown">
                                <img class="lazy user_avatar" @if($res['user']['gender']==1) src="{{url('static/base/admin/img/man.png')}}" @else src="{{url('static/base/admin/img/woman.png')}}" @endif data-original="">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuLink">
                            <a class="dropdown-item" href="{{route('adminRole')}}">角色选择</a>
                            <a class="dropdown-item layout_ajax" href="{{route('adminCache')}}">清空缓存</a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item text-danger layout_ajax " href="{{route('adminLogout')}}">退出</a>
                        </div>
                    </div>
